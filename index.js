...
(function($) {
  ...
  function getMonthHtml(year, month, settings) {
    var monthHtml =
      '<div class="sys-datepicker-month" data-year="' +
      year +
      '" data-month="' +
      month +
      '"><div class="sys-datepicker-month-header">' +
      settings.monthNames[month - 1] +
      " " +
      year +
      "</div>";
    ...
    for (
      var i = 0;
      i < (monthsFirstDayOfWeek + 7 - settings.firstDay) % 7;
      i++
    ) {
  ...
  function populate(dp, settings) {
    ...
    // Add years
    for (
      var y = startYear - (numYears - 1) / 2;
      y <= startYear + (numYears - 1) / 2;
      y++
    ) {
  ...
  $.fn.datepicker = function(options, value) {
    if (options === "show") {
      ...
      this.each(function() {
        ...
        var dp = $(
            '<div class="sys-datepicker" style="display:none"/>'
          ).appendTo("body"),
          ...
          dpHeader = $(
            '<div class="sys-datepicker-header"><div class="sys-datepicker-buttons"><div class="sys-datepicker-button sys-datepicker-button-prevyear">' +
              settings.prevYearText +
              '</div> <div class="sys-datepicker-button sys-datepicker-button-prevmonth">' +
              settings.prevText +
              '</div> <div class="sys-datepicker-button sys-datepicker-button-today">' +
              settings.currentText +
              '</div> <div class="sys-datepicker-button sys-datepicker-button-nextmonth">' +
              settings.nextText +
              '</div> <div class="sys-datepicker-button sys-datepicker-button-nextyear">' +
              settings.nextYearText +
              "</div></div></div>"
          ).appendTo(dpContent),
